...
from .base import BaseAlgo,BaseAlgoRN
...
class A2CAlgoRN(BaseAlgoRN):
    ...
    def update_parameters(self, exps,x_history_stack=None,COMP_stack=None):
        # Compute starting indexes
        ...
        for i in range(self.recurrence):
            ...
            if self.acmodel.recurrent:
                dist, value, memory,x_history_stack,COMP_stack,MDL = self.acmodel(sb.obs, memory * sb.mask,x_history_stack=x_history_stack,COMP_stack=COMP_stack)
            else:
                dist, value,x_history_stack,COMP_stack,MDL = self.acmodel(sb.obs,x_history_stack=x_history_stack,COMP_stack=COMP_stack)
        ...
        return logs, x_history_stack, COMP_stack, MDL
